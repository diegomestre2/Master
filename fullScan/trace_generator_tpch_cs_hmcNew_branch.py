...
for HMC_OPERATION in (256, 256):
    ...
    dynamic_trace = BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
        HMC_OPERATION) + "/branch/output_trace.out.tid0.dyn.out"
    memory_trace = BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
        HMC_OPERATION) + "/branch/output_trace.out.tid0.mem.out"
    static_trace = BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
        HMC_OPERATION) + "/branch/output_trace.out.tid0.stat.out"
    ...
    basicBlock = 0
    print("Generating Traces Files For HMC_NEW... branch Unrolled 32x " + str(HMC_OPERATION) + " Bytes")
    #################### STATIC FILE #########################
    ...
    for i in range(numberOfPredicates):
        ...
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_OP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 32 -1 32\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 1 -1 1\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 2 -1 2\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 3 -1 3\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 4 -1 4\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 5 -1 5\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 6 -1 6\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 7 -1 7\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 8 -1 8\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 9 -1 9\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 10 -1 10\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 11 -1 11\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 12 -1 12\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 13 -1 13\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 14 -1 14\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 15 -1 15\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 16 -1 16\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 17 -1 17\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 18 -1 18\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 19 -1 19\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 20 -1 20\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 21 -1 21\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 22 -1 22\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 23 -1 23\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 24 -1 24\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 25 -1 25\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 26 -1 26\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 27 -1 27\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 28 -1 28\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 29 -1 29\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 30 -1 30\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 31 -1 31\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 32 -1 32\n")
        INSTRUCTION_ADDR += 4
        basicBlock += 1
        FILE_STAT.write("@" + str(basicBlock) + "\n")  # APPLY PREDICATE 2)#
        FILE_STAT.write("HMC_LD 16 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 1 0 0 3 0 0 1 -1 -1 1\n")  # R
        ...
        FILE_STAT.write("HMC_LD 16 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 1 0 0 3 0 0 1 -1 -1 31\n")  # R
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_LD 16 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 1 0 0 3 0 0 1 -1 -1 32\n")  # R
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 1 -1 1\n")
        INSTRUCTION_ADDR += 4
        FILE_STAT.write("HMC_CMP 18 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 0 3 0 0 1 2 -1 2\n")
        ...
        basicBlock += 1
        FILE_STAT.write("@" + str(basicBlock) + "\n")  # APPLY READ BITMAP)#
        FILE_STAT.write("CMP 1 " + str(INSTRUCTION_ADDR) + " 4 2 5 11 1 1 0 0 1 0 0 3 0 0 0\n")  # R 1 Bytes
        INSTRUCTION_ADDR += 4
        ...
        basicBlock += 1
        FILE_STAT.write("@" + str(basicBlock) + "\n")  # APPLY WRITE BITMAP)
        FILE_STAT.write("HMC_ST 17 " + str(INSTRUCTION_ADDR) + " 4 1 5 0 0 0 0 0 1 3 0 0 1 32 -1 -1\n")  # W
        INSTRUCTION_ADDR += 4
                        ...
                        if column > 0:
                            ...
                            for i in range(4):
                                memory_block[column][tuple] += str(
                                    "R " + str(bitmapSize / 4) + " " + str(bitmapAddr) + " " + str(basicBlock + 35) + "\n")
                                bitmapAddr += 32
                        ########################################################################
                        ##  APPLY PREDICATE
                        ########################################################################
