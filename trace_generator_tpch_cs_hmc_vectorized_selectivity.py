...
for HMC_OPERATION in (16, 256):
    for SELECTIVITY in ("0001", "001", "01", "1", "10", "100"):
        ...
        basicBlock = 0
        print("Generating Traces Files For HMC... " + str(HMC_OPERATION) + " Bytes Selectivity " + SELECTIVITY)
        ...
        basicBlock = 0
        print("Generating Traces Files For x86...Unrolled 4x - " + str(HMC_OPERATION) + " Bytes Selectivity " + SELECTIVITY)
        #################### STATIC FILE #########################
        print "Generating Static File..."
        for tuple in range(numberOfPredicates):
            basicBlock += 1
        ...
        basicBlock = 0
        print("Generating Traces Files For HMC...Unrolled 8x - " + str(HMC_OPERATION) + " Bytes Selectivity " + SELECTIVITY)
        #################### STATIC FILE #########################
        print "Generating Static File..."
       ...
       ##################### Unrolled 16x ############################
        ...
        basicBlock = 0
        print("Generating Traces Files For HMC...Unrolled 16x - " + str(HMC_OPERATION) + " Bytes Selectivity " + SELECTIVITY)
        #################### STATIC FILE #########################
        print "Generating Static File..."
        for i in range(numberOfPredicates):
            basicBlock += 1
