...
for HMC_OPERATION in (256, 256):
    for SELECTIVITY in ("0001", "001", "01", "1", "10", "100"):
        ...
        dynamic_trace = BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
            HMC_OPERATION) + "/branch/selectivity/" + SELECTIVITY + "/" + "output_trace.out.tid0.dyn.out"
        memory_trace = BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
            HMC_OPERATION) + "/branch/selectivity/" + SELECTIVITY + "/" + "output_trace.out.tid0.mem.out"
        static_trace = BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
            HMC_OPERATION) + "/branch/selectivity/" + SELECTIVITY + "/" + "output_trace.out.tid0.stat.out"
        ...
        basicBlock = 0
        print("Generating Traces Files For HMC_NEW... branch Unrolled 32x " + str(HMC_OPERATION) + " Bytes" + "SELECTIVITY" + SELECTIVITY)
        #################### STATIC FILE #########################
        ...
        os.system("rm -f " + BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
            HMC_OPERATION) + "/branch/selectivity/" + SELECTIVITY + "/" + "*gz")
        os.system("gzip " + BASEDIR + "traces/" + QUERY + "/columnStore/" + QUERY_ENGINE + "/HMC_NEW/" + str(
            HMC_OPERATION) + "/branch/selectivity/" + SELECTIVITY + "/" + "*.out")
        print "ALL Done!"
